...
public class CreateCompletionCommand : OpenAiResponseCommand
{
    ...
    public CreateCompletionCommand(string name, string message, ILogger logger, ITelegramMessageService telegramMessageService, IOpenAiApiService openAiApiService) 
